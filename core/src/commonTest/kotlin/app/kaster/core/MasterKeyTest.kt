...
import app.kaster.core.MasterKey.Scope.Authentication
...
class MasterKeyTest {
    ...
    fun testMasterKeySalt() {
        val salt = MasterKey.salt("Bender", Authentication)
        assertEquals(
    ...
    fun verifyMasterKeyAlgorithm() {
        val masterKey = MasterKey("Bender", "BiteMyShinyMetalAss!", Authentication)
        assertEquals(
