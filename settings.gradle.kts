...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("testparameterinjector", "com.google.testparameterinjector:test-parameter-injector:1.11")
            ...
            library("androidx-compose-bom", "androidx.compose:compose-bom:2023.05.00")
            ...
            library("androidx-compose-ui-test-junit4", "androidx.compose.ui:ui-test-junit4:1.4.2")
