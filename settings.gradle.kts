...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("androidx-datastore", "androidx.datastore:datastore:1.1.0-beta02")
            ...
            library("androidx-compose-ui-test-junit4", "androidx.compose.ui:ui-test-junit4:1.6.4")
            library("robolectric", "org.robolectric:robolectric:4.12")
        }
    }
}
