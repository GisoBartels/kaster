...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("testparameterinjector", "com.google.testparameterinjector:test-parameter-injector:1.15")
            ...
            library("androidx-datastore", "androidx.datastore:datastore:1.1.0-rc01")
            ...
            library("androidx-compose-ui-test-junit4", "androidx.compose.ui:ui-test-junit4:1.6.5")
            library("robolectric", "org.robolectric:robolectric:4.12.1")
        }
    }
}
