...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("kotest-assertions", "io.kotest:kotest-assertions-core:6.1.11")
            ...
            library("ossLicenses", "com.google.android.gms:play-services-oss-licenses:17.4.0")
            ...
            library("androidx-compose-ui-test-junit4", "androidx.compose.ui:ui-test-junit4:1.10.6")
