...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("kotest-assertions", "io.kotest:kotest-assertions-core:6.0.1")
            ...
            library("ossLicenses", "com.google.android.gms:play-services-oss-licenses:17.2.2")
            ...
            library("androidx-compose-ui-test-junit4", "androidx.compose.ui:ui-test-junit4:1.9.0")
            library("robolectric", "org.robolectric:robolectric:4.15.1")
        }
    }
}
