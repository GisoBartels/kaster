...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("kotest-assertions", "io.kotest:kotest-assertions-core:5.7.2")

            // JVM
            library("password4j", "com.password4j:password4j:1.7.3")

            // JVM test
            library("junit4", "junit:junit:4.13.2")
            library("testparameterinjector", "com.google.testparameterinjector:test-parameter-injector:1.14")
            ...
            library("androidx-compose-ui-test-junit4", "androidx.compose.ui:ui-test-junit4:1.5.2")
        }
    }
}
